package com.readtracker_beta.thirdparty.views;
...
import com.readtracker_beta.thirdparty.text.method.AllCapsTransformationMethod;
import com.readtracker_beta.thirdparty.text.method.TransformationMethodCompat2;
...
public class Switch extends CompoundButton
{
	...
	public void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		final int switchHeight = mTrackDrawable.getIntrinsicHeight() + 6;
